    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <x-link-active class="" :active="request()->route('order') === 'asc'" href="{{ route('tasks.index', ['order' => 'asc']) }}">
                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"><path fill="#4d4847" d="m7 14l5-5l5 5z"/></svg>
                </x-link-active>
                <x-link-active :active="request()->route('order') === 'desc'" href="{{ route('tasks.index', ['order' => 'desc']) }}">
